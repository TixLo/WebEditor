export function withLineNumbers(highlight, options = {}) {
    const opts = Object.assign({ class: "codejar-linenumbers", wrapClass: "codejar-wrap", width: "55px", backgroundColor: "rgba(55, 66, 80, 1)", color: "#FF0" }, options);
    let lineNumbers;
